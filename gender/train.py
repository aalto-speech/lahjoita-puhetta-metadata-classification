...
def train(pairs_batch_train, pairs_batch_dev, pairs_batch_dev_acc, x_vector_model, criterion, optimizer, num_epochs, batch_size, train_data_len, dev_data_len, device):
    ...
    for epoch in range(1, 41):
        ...
        for iteration, batch in enumerate(pairs_batch_train):
            ...
            train_loss = criterion(output, gender_seqs)
            train_loss.backward()
        ...
        with torch.no_grad():
            ...
            for iteration, batch in enumerate(pairs_batch_dev):
                ...
                dev_loss = criterion(output, gender_seqs)
        ...
        accuracy = accuracy_score(true_gender, predicted_gender)
        ...
        with open('loss/model_3_seconds.txt', 'a') as f:
        ...
        }, 'weights/model_3_seconds/state_dict_' + str(epoch) + '.pt')
